...
def extract_pdf_text_sample(file_path: str, max_pages: int = 3, max_chars: int = 5000) -> str:
    """
    Extract text sample from the first few pages of a PDF for metadata extraction.
