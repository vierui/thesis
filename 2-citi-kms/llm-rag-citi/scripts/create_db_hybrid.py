...
# Load .env from project root (auto-discovery), fallback to project root relative to this script
...
if len(sys.argv) < 3:
    raise Exception("Please provide an environment name and a database name, e.g., 'default dev'")
